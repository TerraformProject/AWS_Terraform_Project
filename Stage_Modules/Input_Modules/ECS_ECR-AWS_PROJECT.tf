...
#----------------------------------#
registry_access_policy_file = "Stage_Modules/Standby_Folder/ecr-reg-policy.json" # Local path to policy file with valid JSON syntax
...
ecr_repositories = {
    ...
    ecr_repo_001 = {
        ...
        lifecycle_hook_policy_file = "Stage_Modules/Standby_Folder/ecr_lifecycle_hook.json" # Local path to policy file with valide JSON syntax
        #- Scanning ---------------#
        scan_on_push = true
        #- Encryption -------------#
        ...
        #- Access Policy ----------#
        repo_access_policy_file = "Stage_Modules/Standby_Folder/ecr-repo-policy.json" # Local path to policy file with valid JSON syntax
        #- Tags -------------------#
        repo_tags = {}
    }
    #------------------------------#
