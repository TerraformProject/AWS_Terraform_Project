...
variable "create_scaling_configuration" {
  description = "Whether to create a scaling configuration with the settings specified"
  type        = map(string)
  default     = {}
}
...
variable "cluster_instance_tags" {
  description = "A map of tags to add to the RDS cluster Instance. Used for AWS Instance Scheduler tagging"
  type        = map(string)
  default     = {}
}
...
variable "restore_to_point_in_time" {
  description = "Configuration map used to restore to previous point"
  type        = map(any)
  default     = null
}
